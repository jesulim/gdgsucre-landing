...
const FrequentQuestionsAccordion = ({id, question, answer}: Props) => {
    return (
        <details className="group border border-green-four rounded-lg shadow-md" key={id}>
          ...
          {/* Icono */}
          <svg className="w-5 h-5 transition-transform group-open:rotate-90 text-green-four " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
