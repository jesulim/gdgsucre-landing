  ...
  return (
    <div key={id}>
      ...
      <div className='transition-duration-300 pointer-events-auto h-full pb-4 pl-4 mix-blend-luminosity transition-all hover:!scale-100 hover:!blur-none md:group-hover:scale-[0.90] md:group-hover:blur-[1px]'>
        <div className='relative flex h-full w-full flex-col items-center space-y-2 border-2 bg-white px-2 pb-4 text-center dark:bg-black md:pb-8 md:pt-4'>
          <div
            className={`absolute -bottom-2 -left-2 -z-10 h-full w-full sm:-bottom-3 sm:-left-3 ${bgColors[id % 4]}`}
          ></div>
