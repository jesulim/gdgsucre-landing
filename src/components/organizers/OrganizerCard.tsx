      ...
      <div className='relative aspect-[4/5]' key={id}>
        ...
        <div className='absolute inset-0 bg-white dark:bg-dark-background rounded-2xl sm:rounded-3xl shadow-md overflow-hidden border-2 border-black dark:border-white sm:border-2'>
          <div className='p-2 sm:p-4 lg:p-6 flex flex-col items-center justify-center h-full'>
            <div className='w-16 h-16 sm:w-24 sm:h-24 lg:w-32 lg:h-32 rounded-full overflow-hidden mb-2 sm:mb-4 border border-gray-300 dark:border-white sm:border-2'>
              <img
                src={photoUrl}
                alt={name}
            ...
            <h2 className='text-sm sm:text-lg lg:text-xl font-bold text-center mb-1 dark:text-dark-text'>{name}</h2>
            <p className="text-sm sm:text-lg lg:text-xl font-light text-center mb-1 dark:text-dark-text">Organizer</p>
          </div>
        </div>
      </div>
    </div>
